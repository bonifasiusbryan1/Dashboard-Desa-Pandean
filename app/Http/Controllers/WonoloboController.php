...
class WonoloboController extends Controller
{
    public function wonoloboData()
    {
        ...
        $mataPencaharianData = MataPencaharian::where('id_dusun', 8)
            ->where('id_tahun', 1)
            ->get();
        ...
        $usiaData = Usia::where('id_dusun', 8)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasBayiData = KualitasBayi::where('id_dusun', 8)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasIbuHamilData = KualitasIbuHamil::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $statusBalitaData = StatusBalita::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $imunisasiData = Imunisasi::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $rasioGuruMuridData = RasioGuruMurid::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $statusPendidikanData = WajibBelajar::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $agamaData = Agama::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $tingkatPendidikanData = TingkatPendidikan::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $kebutuhanAirData = KebutuhanAir::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        $asetTanahData = AsetTanah::where('id_dusun', 8)
        ->where('id_tahun', 1)
        ->get();
        ...
        return view('dashboard.wonolobo', [
    ...
    public function wonoloboData_2()
    {
        $pendapatanData = PendapatanPerkapita::with('tahun', 'dusun', 'jenisSektor')
        ->where('id_dusun', 8)
        ->where('id_tahun', 1)
        ...
        return view('dashboard.wonolobo_2', [
            'pendapatanChartData' => $pendapatanChartData,
            'sectors' => $sectors,
            'totalPekerja' => $totalPekerja,
            'pekerjaanChartData' => $pekerjaanChartData,
    ...
    public function formPendapatan(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('pendapatanPerkapita'));
    }
    ...
    public function formMataPencaharian(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('mataPencaharian', 'year'));
    }
    ...
    public function formPekerjaan(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('pekerjaan', 'year'));
    }
    ...
    public function formUsia(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('usiaData', 'year'));
    }
    ...
    public function formKualitasBayi(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('kualitasBayiData', 'year'));
    }
    ...
    public function formKualitasIbuHamil(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('kualitasIbuHamilData', 'year'));
    }
    ...
    public function formStatusBalita(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('statusBalitaData', 'year'));
    }
    ...
    public function formImunisasi(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('imunisasiData', 'year'));
    }
    ...
    public function formRasioGuruMurid(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('rasioGuruMurid', 'year'));
    }
    ...
    public function formStatusPendidikan(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('statusPendidikan', 'year'));
    }
    ...
    public function formAgama(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('agamaData', 'year'));
    }
    ...
    public function formTingkatPendidikan(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('tingkatPendidikanData', 'year'));
    }
    ...
    public function formKebutuhanAir(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('kebutuhanAirData', 'year'));
    }
    ...
    public function formAsetTanah(Request $request)
    {
        ...
        return view('inputdata.wonolobo', compact('asetTanahData', 'year'));
    }
