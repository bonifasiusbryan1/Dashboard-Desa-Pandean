...
class SidadapController extends Controller
{
    public function sidadapData()
    {
        ...
        $mataPencaharianData = MataPencaharian::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $usiaData = Usia::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasBayiData = KualitasBayi::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasIbuHamilData = KualitasIbuHamil::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $statusBalitaData = StatusBalita::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $imunisasiData = Imunisasi::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $rasioGuruMuridData = RasioGuruMurid::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $statusPendidikanData = WajibBelajar::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $agamaData = Agama::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $tingkatPendidikanData = TingkatPendidikan::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kebutuhanAirData = KebutuhanAir::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
        ...
        $asetTanahData = AsetTanah::where('id_dusun', 3)
            ->where('id_tahun', 1)
            ->get();
    ...
    public function sidadapData_2()
    {
        ...
        return view('dashboard.sidadap_2', [
            'pendapatanChartData' => $pendapatanChartData,
            'sectors' => $sectors,
            'totalPekerja' => $totalPekerja,
            'pekerjaanChartData' => $pekerjaanChartData,
    ...
    public function formPendapatan(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('pendapatanPerkapita'));
    }
    ...
    public function formMataPencaharian(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('mataPencaharian', 'year'));
    }
    ...
    public function formPekerjaan(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('pekerjaan', 'year'));
    }
    ...
    public function formUsia(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('usiaData', 'year'));
    }
    ...
    public function formKualitasBayi(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('kualitasBayiData', 'year'));
    }
    ...
    public function formKualitasIbuHamil(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('kualitasIbuHamilData', 'year'));
    }
    ...
    public function formStatusBalita(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('statusBalitaData', 'year'));
    }
    ...
    public function formImunisasi(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('imunisasiData', 'year'));
    }
    ...
    public function formRasioGuruMurid(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('rasioGuruMurid', 'year'));
    }
    ...
    public function formStatusPendidikan(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('statusPendidikan', 'year'));
    }
    ...
    public function formAgama(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('agamaData', 'year'));
    }
    ...
    public function formTingkatPendidikan(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('tingkatPendidikanData', 'year'));
    }
    ...
    public function formKebutuhanAir(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('kebutuhanAirData', 'year'));
    }
    ...
    public function formAsetTanah(Request $request)
    {
        ...
        return view('inputdata.sidadap', compact('asetTanahData', 'year'));
    }
