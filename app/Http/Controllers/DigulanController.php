...
class DigulanController extends Controller
{
    public function digulanData()
    {
        ...
        $mataPencaharianData = MataPencaharian::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $usiaData = Usia::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasBayiData = KualitasBayi::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kualitasIbuHamilData = KualitasIbuHamil::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $statusBalitaData = StatusBalita::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $imunisasiData = Imunisasi::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $rasioGuruMuridData = RasioGuruMurid::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $statusPendidikanData = WajibBelajar::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $agamaData = Agama::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $tingkatPendidikanData = TingkatPendidikan::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $kebutuhanAirData = KebutuhanAir::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
        ...
        $asetTanahData = AsetTanah::where('id_dusun', 6)
            ->where('id_tahun', 1)
            ->get();
    ...
    public function digulanData_2()
    {
        ...
        return view('dashboard.digulan_2', [
            'pendapatanChartData' => $pendapatanChartData,
            'sectors' => $sectors,
            'totalPekerja' => $totalPekerja,
            'pekerjaanChartData' => $pekerjaanChartData,
    ...
    public function formPendapatan(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('pendapatanPerkapita'));
    }
    ...
    public function formMataPencaharian(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('mataPencaharian', 'year'));
    }
    ...
    public function formPekerjaan(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('pekerjaan', 'year'));
    }
    ...
    public function formUsia(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('usiaData', 'year'));
    }
    ...
    public function formKualitasBayi(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('kualitasBayiData', 'year'));
    }
    ...
    public function formKualitasIbuHamil(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('kualitasIbuHamilData', 'year'));
    }
    ...
    public function formStatusBalita(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('statusBalitaData', 'year'));
    }
    ...
    public function formImunisasi(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('imunisasiData', 'year'));
    }
    ...
    public function formRasioGuruMurid(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('rasioGuruMurid', 'year'));
    }
    ...
    public function formStatusPendidikan(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('statusPendidikan', 'year'));
    }
    ...
    public function formAgama(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('agamaData', 'year'));
    }
    ...
    public function formTingkatPendidikan(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('tingkatPendidikanData', 'year'));
    }
    ...
    public function formKebutuhanAir(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('kebutuhanAirData', 'year'));
    }
    ...
    public function formAsetTanah(Request $request)
    {
        ...
        return view('inputdata.digulan', compact('asetTanahData', 'year'));
    }
