...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            ...
            <div class="flex items-center justify-center flex-grow text-white">
                ...
                <span class="mx-3 text-xl sm:text-2xl font-semibold nav-title">
                    Input Data Kependudukan Dusun Digulan
                </span>
            </div>
            <div class="w-7"></div>
        </div>
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pendapatan-form" method="POST" action="{{ route('storePendapatandigulan') }}">
            @csrf
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="mata_pencaharian-form" method="POST" action="{{ route('storeMataPencahariandigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pekerjaan-form" method="POST" action="{{ route('storePekerjaandigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="usia-form" method="POST" action="{{ route('storeUsiadigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasbayi-form" method="POST" action="{{ route('storeKualitasBayidigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasibuhamil-form" method="POST" action="{{ route('storeKualitasIbuHamildigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statusbalita-form" method="POST" action="{{ route('storeStatusBalitadigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="imunisasi-form" method="POST" action="{{ route('storeImunisasidigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="rasiogurumurid-form" method="POST" action="{{ route('storeRasioGuruMuriddigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statuspendidikan-form" method="POST" action="{{ route('storeStatusPendidikandigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="agama-form" method="POST" action="{{ route('storeAgamadigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="tingkatpendidikan-form" method="POST" action="{{ route('storeTingkatPendidikandigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kebutuhanair-form" method="POST" action="{{ route('storeKebutuhanAirdigulan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 mb-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="asettanah-form" method="POST" action="{{ route('storeAsetTanahdigulan') }}">
            @csrf
            <div class="text-center mb-6">
