...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            ...
            <div class="flex items-center justify-center flex-grow text-white">
                ...
                <span class="mx-3 text-xl sm:text-2xl font-semibold nav-title">
                    Input Data Kependudukan Dusun Wonolobo
                </span>
            </div>
            <div class="w-7"></div>
        </div>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            @if (Auth::check())
                ...
                @elseif ($id_dusun == 8)
                    <a href="{{ route('dashboard.wonolobo') }}" class="sidebar-item">
                        <i class="bi bi-clipboard-data-fill mr-3"></i> Wonolobo
                    </a>
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pendapatan-form" method="POST" action="{{ route('storePendapatanwonolobo') }}">
            @csrf
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="mata_pencaharian-form" method="POST" action="{{ route('storeMataPencaharian') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pekerjaan-form" method="POST" action="{{ route('storePekerjaan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="usia-form" method="POST" action="{{ route('storeUsia') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasbayi-form" method="POST" action="{{ route('storeKualitasBayi') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasibuhamil-form" method="POST" action="{{ route('storeKualitasIbuHamil') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statusbalita-form" method="POST" action="{{ route('storeStatusBalita') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="imunisasi-form" method="POST" action="{{ route('storeImunisasi') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="rasiogurumurid-form" method="POST" action="{{ route('storeRasioGuruMurid') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statuspendidikan-form" method="POST" action="{{ route('storeStatusPendidikan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="agama-form" method="POST" action="{{ route('storeAgama') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="tingkatpendidikan-form" method="POST" action="{{ route('storeTingkatPendidikan') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kebutuhanair-form" method="POST" action="{{ route('storeKebutuhanAir') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 mb-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="asettanah-form" method="POST" action="{{ route('storeAsetTanah') }}">
            @csrf
            <div class="text-center mb-6">
