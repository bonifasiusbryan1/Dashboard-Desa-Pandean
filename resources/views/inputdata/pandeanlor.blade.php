...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            ...
            <div class="flex items-center justify-center flex-grow text-white">
                ...
                <span class="mx-3 text-xl sm:text-2xl font-semibold nav-title">
                    Input Data Kependudukan Dusun Pandean Lor
                </span>
            </div>
            <div class="w-7"></div>
        </div>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            @if (Auth::check())
                ...
                @elseif ($id_dusun == 4)
                    <a href="{{ route('dashboard.pandeanlor') }}" class="sidebar-item">
                        <i class="bi bi-clipboard-data-fill mr-3"></i> Pandean Lor
                    </a>
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pendapatan-form" method="POST" action="{{ route('storePendapatanpandeanlor') }}">
            @csrf
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="mata_pencaharian-form" method="POST" action="{{ route('storeMataPencaharianpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pekerjaan-form" method="POST" action="{{ route('storePekerjaanpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="usia-form" method="POST" action="{{ route('storeUsiapandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasbayi-form" method="POST" action="{{ route('storeKualitasBayipandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasibuhamil-form" method="POST" action="{{ route('storeKualitasIbuHamilpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statusbalita-form" method="POST" action="{{ route('storeStatusBalitapandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="imunisasi-form" method="POST" action="{{ route('storeImunisasipandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="rasiogurumurid-form" method="POST" action="{{ route('storeRasioGuruMuridpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statuspendidikan-form" method="POST" action="{{ route('storeStatusPendidikanpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="agama-form" method="POST" action="{{ route('storeAgamapandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="tingkatpendidikan-form" method="POST" action="{{ route('storeTingkatPendidikanpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kebutuhanair-form" method="POST" action="{{ route('storeKebutuhanAirpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 mb-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="asettanah-form" method="POST" action="{{ route('storeAsetTanahpandeanlor') }}">
            @csrf
            <div class="text-center mb-6">
