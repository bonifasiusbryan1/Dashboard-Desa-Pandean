...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            ...
            <div class="flex items-center justify-center flex-grow text-white">
                ...
                <span class="mx-3 text-xl sm:text-2xl font-semibold nav-title">
                    Input Data Kependudukan Dusun Tanggulangin
                </span>
            </div>
            <div class="w-7"></div>
        </div>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            @if (Auth::check())
                ...
                @elseif ($id_dusun == 7)
                    <a href="{{ route('dashboard.tanggulangin') }}" class="sidebar-item">
                        <i class="bi bi-clipboard-data-fill mr-3"></i> Tanggulangin
                    </a>
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pendapatan-form" method="POST" action="{{ route('storePendapatantanggulangin') }}">
            @csrf
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="mata_pencaharian-form" method="POST" action="{{ route('storeMataPencahariantanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pekerjaan-form" method="POST" action="{{ route('storePekerjaantanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="usia-form" method="POST" action="{{ route('storeUsiatanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasbayi-form" method="POST" action="{{ route('storeKualitasBayitanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasibuhamil-form" method="POST" action="{{ route('storeKualitasIbuHamiltanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statusbalita-form" method="POST" action="{{ route('storeStatusBalitatanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="imunisasi-form" method="POST" action="{{ route('storeImunisasitanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="rasiogurumurid-form" method="POST" action="{{ route('storeRasioGuruMuridtanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statuspendidikan-form" method="POST" action="{{ route('storeStatusPendidikantanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="agama-form" method="POST" action="{{ route('storeAgamatanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="tingkatpendidikan-form" method="POST" action="{{ route('storeTingkatPendidikantanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kebutuhanair-form" method="POST" action="{{ route('storeKebutuhanAirtanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 mb-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="asettanah-form" method="POST" action="{{ route('storeAsetTanahtanggulangin') }}">
            @csrf
            <div class="text-center mb-6">
