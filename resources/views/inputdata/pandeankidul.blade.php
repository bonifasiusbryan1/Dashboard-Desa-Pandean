...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            ...
            <div class="flex items-center justify-center flex-grow text-white">
                ...
                <span class="mx-3 text-xl sm:text-2xl font-semibold nav-title">
                    Input Data Kependudukan Dusun Pandean Kidul
                </span>
            </div>
            <div class="w-7"></div>
        </div>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            ...
            @if (Auth::check())
                ...
                @elseif ($id_dusun == 2)
                    <a href="{{ route('dashboard.pandeankidul') }}" class="sidebar-item">
                        <i class="bi bi-clipboard-data-fill mr-3"></i> Pandean Kidul
                    </a>
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pendapatan-form" method="POST" action="{{ route('storePendapatanpandeankidul') }}">
            @csrf
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="mata_pencaharian-form" method="POST" action="{{ route('storeMataPencaharianpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
                <h2 class="text-base md:text-lg font-bold text-gray-900">Mata Pencaharian</h2>
                <p class="text-sm text-gray-600">Merupakan gambaran mata pencaharian masyarakat per sektor usaha.</p>
            </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="peroranganpertanian" name="peroranganpertanian" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="peroranganpeternakan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Peternakan</label>
                    <input type="text" id="peroranganpeternakan" name="peroranganpeternakan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="peroranganjasaperdagangan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Jasa dan Perdagangan</label>
                    <input type="text" id="peroranganjasaperdagangan" name="peroranganjasaperdagangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="peroranganindustri" class="block mb-2 text-sm font-medium text-gray-900">Sektor Industri</label>
                    <input type="text" id="peroranganindustri" name="peroranganindustri" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
            </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="usahapertanian" name="usahapertanian" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="usahapeternakan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Peternakan</label>
                    <input type="text" id="usahapeternakan" name="usahapeternakan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="usahajasaperdagangan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Jasa dan Perdagangan</label>
                    <input type="text" id="usahajasaperdagangan" name="usahajasaperdagangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="usahaindustri" class="block mb-2 text-sm font-medium text-gray-900">Sektor Industri</label>
                    <input type="text" id="usahaindustri" name="usahaindustri" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
            </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="buruhpertanian" name="buruhpertanian" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="buruhpeternakan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Peternakan</label>
                    <input type="text" id="buruhpeternakan" name="buruhpeternakan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="buruhjasaperdagangan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Jasa dan Perdagangan</label>
                    <input type="text" id="buruhjasaperdagangan" name="buruhjasaperdagangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
                <div>
                    <label for="buruhindustri" class="block mb-2 text-sm font-medium text-gray-900">Sektor Industri</label>
                    <input type="text" id="buruhindustri" name="buruhindustri" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 500" required readonly />
                </div>
            </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="jumlahpertanian" name="jumlahpertanian" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 1.000" required readonly />
                </div>
                <div>
                    <label for="jumlahpeternakan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Peternakan</label>
                    <input type="text" id="jumlahpeternakan" name="jumlahpeternakan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 1.000" required readonly />
                </div>
                <div>
                    <label for="jumlahjasaperdagangan" class="block mb-2 text-sm font-medium text-gray-900">Sektor Jasa dan Perdagangan</label>
                    <input type="text" id="jumlahjasaperdagangan" name="jumlahjasaperdagangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 1.000" required readonly />
                </div>
                <div>
                    <label for="jumlahindustri" class="block mb-2 text-sm font-medium text-gray-900">Sektor Industri</label>
                    <input type="text" id="jumlahindustri" name="jumlahindustri" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contoh: 1.000" required readonly />
                </div>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <button type="button" id="edit-button-mp" class="text-gray-700 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Edit</button>
                <button type="reset" id="reset-button-mp" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Reset</button>
            </div>

            @if (session('success_mata_pencaharian'))
                <div class="mt-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
                    <strong class="font-bold">Success!</strong>
                    <span class="block sm:inline">{{ session('success_mata_pencaharian') }}</span>
                </div>
            @endif
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="pekerjaan-form" method="POST" action="{{ route('storePekerjaanpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="usia-form" method="POST" action="{{ route('storeUsiapandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasbayi-form" method="POST" action="{{ route('storeKualitasBayipandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kualitasibuhamil-form" method="POST" action="{{ route('storeKualitasIbuHamilpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statusbalita-form" method="POST" action="{{ route('storeStatusBalitapandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="imunisasi-form" method="POST" action="{{ route('storeImunisasipandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="rasiogurumurid-form" method="POST" action="{{ route('storeRasioGuruMuridpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="statuspendidikan-form" method="POST" action="{{ route('storeStatusPendidikanpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="agama-form" method="POST" action="{{ route('storeAgamapandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="tingkatpendidikan-form" method="POST" action="{{ route('storeTingkatPendidikanpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="kebutuhanair-form" method="POST" action="{{ route('storeKebutuhanAirpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
    ...
    <div class="container mx-auto mt-4 mb-4 px-4">
        <form class="bg-white p-8 rounded-lg shadow-md" id="asettanah-form" method="POST" action="{{ route('storeAsetTanahpandeankidul') }}">
            @csrf
            <div class="text-center mb-6">
                ...
                setupInputValidation() {
                    this.inputIds.forEach(id => {
                        ...
                        if (input) {
                            ...
                            if (this.formId === 'pendapatan-form') {
